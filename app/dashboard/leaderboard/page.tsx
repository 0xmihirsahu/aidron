          ...
          <div className="flex flex-col items-center">
            <Card className="mb-4 min-w-[200px]">
              <CardHeader className="text-center pb-2">
                ...
                <p className="text-xs text-muted-foreground">{topAgents[1].creator}</p>
              </CardHeader>
          ...
          <div className="flex flex-col items-center">
            <Card className="mb-4 min-w-[200px] ring-2 ring-yellow-500/20">
              <CardHeader className="text-center pb-2">
                ...
                <p className="text-xs text-muted-foreground">{topAgents[0].creator}</p>
              </CardHeader>
              <CardContent className="pt-0">
                <div className="space-y-2 text-xs">
                  <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-center">
            <Card className="mb-4 min-w-[200px]">
              <CardHeader className="text-center pb-2">
                ...
                <p className="text-xs text-muted-foreground">{topAgents[2].creator}</p>
              </CardHeader>
              <CardContent className="pt-0">
                <div className="space-y-2 text-xs">
                  <div className="flex items-center justify-between">
            ...
            <TableBody>
              {otherAgents.map((agent) => (
                <TableRow key={agent.id}>
                  ...
                  <TableCell>
                    <span className="font-medium">${agent.treasury}</span>
                  </TableCell>
                  <TableCell>
                    {agent.users}
                  </TableCell>
