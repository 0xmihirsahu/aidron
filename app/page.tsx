  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="container relative mx-auto px-4 py-32 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between py-48 items-center gap-8">
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              <h3 className="text-2xl font-semibold">Create Your SLM</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-semibold">Own Your Model</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-semibold">Monetize</h3>
          ...
          <div className="bg-neutral-900 backdrop-blur-sm p-8 rounded-xl shadow-2xl">
            <Entropy size={400}/>
          </div>
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              <h3 className="text-2xl font-semibold">No Technical Expertise</h3>
