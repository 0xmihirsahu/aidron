...
export default function Home() {
  ...
  return (
    ...
    />
      ...
      />
        <div className="flex-1 space-y-4 sm:space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">Build custom AI models tailored to your specific domain or use case, with no coding required.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl sm:text-2xl text-white font-semibold">Own Your Model</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Maintain full ownership and control of your AI models. Deploy them anywhere and monetize as you see fit.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl sm:text-2xl text-white font-semibold">Monetize</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Turn your domain expertise into revenue by selling access to your specialized AI models.</p>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-4 sm:space-y-6">
            <div className="space-y-2">
              <h3 className="text-xl sm:text-2xl text-white font-semibold">No Technical Expertise</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Our intuitive platform handles the complex technical details, letting you focus on your domain knowledge.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl sm:text-2xl text-white font-semibold">Rapid Development</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Go from concept to deployment in minutes with our streamlined SLM building process.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-xl sm:text-2xl text-white font-semibold">Full Support</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Get comprehensive support throughout your AI journey, from model creation to deployment.</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-20">
          <div className="px-4 sm:pl-24 z-50 m-8 sm:m-24 max-w-4xl">
            <h1 className="font-inter text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
              Bridging AI and Human Economy with <span className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 bg-clip-text text-transparent">$XY</span>
            </h1>
            <p className="text-lg sm:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl">
              Where artificial intelligence meets human potential. Create, collaborate, and capitalize on the future of work.
            </p>
          </div>
          <Image 
      ...
      <div className="flex flex-col sm:flex-row font-mono mx-auto w-[85%] sm:w-6/8 bg-neutral-900 justify-around my-8 sm:my-12 py-24 sm:py-20 px-4 sm:px-16 rounded-[28px] sm:rounded-[50px] items-center gap-6 sm:gap-6 relative">
